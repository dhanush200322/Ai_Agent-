...
let MetricsEngine = class MetricsEngine {
    ...
    getCounter(name, help, labelNames = []) {
    ...
    getHistogram(name, help, labelNames = []) {
...
exports.MetricsEngine = MetricsEngine = __decorate([
