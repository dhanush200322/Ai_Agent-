...
class MemoryRetrievalService {
     ...
     */
    async retrieveMemories(organizationId, conversationId, query, limit = 10) {
        ...
        const searchResults = await vectorService.similaritySearch(organizationId, queryVector, {
        ...
        for (const mem of rankedMemories) {
            ...
            if (uniqueMemories.length >= limit)
                break;
        }
