...
export class LoopNode implements BaseWorkflowNode {
  type = 'loop';
...
export class DelayNode implements BaseWorkflowNode {
  type = 'delay';

  async execute(node: WorkflowNodeData, _context: WorkflowExecutionContext): Promise<NodeExecutionResult> {
