  ...
  return (
    <GuestGuard>
      <div className="min-h-screen w-full flex bg-[#050505]">
        ...
        <div className="hidden md:flex md:w-[35%] lg:w-[45%] xl:w-[40%] flex-col justify-between border-r border-[rgba(255,255,255,0.05)] bg-[#0B0B0B] p-8 lg:p-12 relative overflow-hidden">
          <BrandPanel />
        </div>
